...
const projects = [
  {
    ...
    description: "В рамках проекта разрабатывалась новая версия магазина на React со всем его функционалом. Для переноса на более современные технологии. Детали проекта, над которым я работал, находятся под соглашением о конфиденциальности, поэтому я не могу их обсуждать.",
